...
import (
	...
	v1 "github.com/edgelive/pkg/listers/rule/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.RuleV1().Rules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RuleV1().Rules(namespace).Watch(context.TODO(), options)
			},
		},
		&rulev1.Rule{},
		resyncPeriod,
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rulev1.Rule{}, f.defaultInformer)
}
