...
import (
	...
	v1 "github.com/edgelive/pkg/listers/service/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ServiceV1().Services(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServiceV1().Services(namespace).Watch(context.TODO(), options)
			},
		},
		&servicev1.Service{},
		resyncPeriod,
