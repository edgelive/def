...
import (
	...
	v1 "github.com/edgelive/def/listers/node/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NodeV1().Nodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NodeV1().Nodes(namespace).Watch(context.TODO(), options)
			},
		},
		&nodev1.Node{},
		resyncPeriod,
