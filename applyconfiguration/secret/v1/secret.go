...
type SecretApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *secretv1.SecretSpec `json:"spec,omitempty"`
}
...
func (b *SecretApplyConfiguration) WithSpec(value secretv1.SecretSpec) *SecretApplyConfiguration {
	b.Spec = &value
	return b
}
