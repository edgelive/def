...
type ServiceApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *servicev1.ServiceSpec `json:"spec,omitempty"`
}
...
func (b *ServiceApplyConfiguration) WithSpec(value servicev1.ServiceSpec) *ServiceApplyConfiguration {
	b.Spec = &value
	return b
}
