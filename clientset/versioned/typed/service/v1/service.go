...
import (
	...
	v1 "github.com/edgelive/pkg/apis/service/v1"
	servicev1 "github.com/edgelive/pkg/applyconfiguration/service/v1"
...
func newServices(c *ServiceV1Client, namespace string) *services {
	return &services{
		client: c.RESTClient(),
		ns:     namespace,
	}
