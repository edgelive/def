...
import (
	...
	secretv1 "github.com/edgelive/def/applyconfiguration/secret/v1"
...
type SecretInterface interface {
	...
	Apply(ctx context.Context, secret *secretv1.SecretApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Secret, err error)
	SecretExpansion
}
...
func newSecrets(c *SecretV1Client, namespace string) *secrets {
	return &secrets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *secrets) Apply(ctx context.Context, secret *secretv1.SecretApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Secret, err error) {
	if secret == nil {
