...
type NodeInterface interface {
	...
	Apply(ctx context.Context, node *nodev1.NodeApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Node, err error)
	NodeExpansion
}
...
func newNodes(c *NodeV1Client, namespace string) *nodes {
	return &nodes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodes) Apply(ctx context.Context, node *nodev1.NodeApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Node, err error) {
	if node == nil {
