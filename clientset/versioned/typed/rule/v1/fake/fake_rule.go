...
func (c *FakeRules) Apply(ctx context.Context, rule *rulev1.RuleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Rule, err error) {
	if rule == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(rulesResource, c.ns, *name, types.ApplyPatchType, data), &v1.Rule{})
